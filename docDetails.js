const getparams = () => {
  ...
  loadTime(param);
  fetch(`https://careancestry.onrender.com/doctor/list/${param}`)
    .then((res) => res.json())
    .then((data) => displayDetails(data));

  fetch(`https://careancestry.onrender.com/doctor/reviews/?doctor_id=${param}`)
    .then((res) => res.json())
...
const loadTime = (id) => {
  fetch(
    `https://careancestry.onrender.com/doctor/available_time/?doctor_id=${id}`
  )
    .then((res) => res.json())
    .then((data) => {
      data.forEach((item) => {
...
const handleAppointment = () => {
  ...
  console.log(info);
  fetch("https://careancestry.onrender.com/appointment/", {
    method: "POST",
...
const loadPatientId = () => {
  ...
  fetch(`https://careancestry.onrender.com/patient/list/?user_id=${user_id}`)
    .then((res) => res.json())
    .then((data) => {
